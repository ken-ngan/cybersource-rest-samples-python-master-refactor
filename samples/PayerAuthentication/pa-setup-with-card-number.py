...
def rest_pa_setup_with_card_number(cardType, expMonth, expYear, cardNumber):
    ...
    print("\n----- samples/PayerAuthentication/pa-setup-with-card-number.py -----")
...
if __name__ == "__main__":
    rest_pa_setup_with_card_number("001", "12", "2025", "4000000000000101")
