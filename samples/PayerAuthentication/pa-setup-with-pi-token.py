...
def pa_setup_with_pi_token(referenceInfoCode, customerId):
    clientReferenceInformationCode = referenceInfoCode
    clientReferenceInformation = Riskv1decisionsClientReferenceInformation(
        code = clientReferenceInformationCode
    )

    paymentInformationCustomerCustomerId = customerId
    ...
    print("\n----- samples/PayerAuthentication/pa-setup-with-pi-token.py -----")
...
if __name__ == "__main__":
    pa_setup_with_pi_token("cybs_test", "AB695DA801DD1BB6E05341588E0A3BDC")
