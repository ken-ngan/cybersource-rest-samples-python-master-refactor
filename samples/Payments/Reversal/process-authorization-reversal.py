...
def process_authorization_reversal(id):
    ...
    clientReferenceInformationCode = "CUP250603C"
    clientReferenceInformation = Ptsv2paymentsidreversalsClientReferenceInformation(
        code = clientReferenceInformationCode
    )

    reversalInformationAmountDetailsTotalAmount = "1"
    reversalInformationAmountDetailsCurrency = "HKD"
    reversalInformationAmountDetails = Ptsv2paymentsidreversalsReversalInformationAmountDetails(
        ...
        currency=reversalInformationAmountDetailsCurrency
    )
...
if __name__ == "__main__":
    process_authorization_reversal("7489316065876715504893")
