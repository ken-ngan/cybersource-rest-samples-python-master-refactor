...
def digital_payments_cryptogram(flag):
    clientReferenceInformationCode = "KN25032501"
    ...
    processingInformationPaymentSolution = "014" # Mastercard COF payment network token
    # processingInformationPaymentSolution = "015" # Visa COF payment network token
    ...
    paymentInformationTokenizedCardNumber = "5214150086628660"
    paymentInformationTokenizedCardExpirationMonth = "04"
    paymentInformationTokenizedCardExpirationYear = "2028"
    paymentInformationTokenizedCardCryptogram = "AOs3/UUZkINhAAJCgRGZAAADFA=="
    paymentInformationTokenizedCardTransactionType = "3"
    paymentInformationTokenizedCardRequestorId = "50162233570"
    ...
    paymentInformationTokenizedCard = Ptsv2paymentsPaymentInformationTokenizedCard(
        ...
        requestor_id = paymentInformationTokenizedCardRequestorId
    )
    ...
    orderInformationAmountDetailsTotalAmount = "1"
...
if __name__ == "__main__":
    digital_payments_cryptogram(False)
