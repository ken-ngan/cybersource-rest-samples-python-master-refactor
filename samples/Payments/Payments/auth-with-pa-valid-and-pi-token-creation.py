...
def auth_with_pa_valid_and_pi_token_creation(referenceInfoCode, cardNumber, expMonth, expYear, cardType, currency, totalAmount, firstName, lastName, address, locality, postalCode, country, email, phone, transaction_id, capture):
    ...
    print("\n----- samples/Payments/Payments/auth-with-pa-valid-and-pi-token-creation.py -----")
...
if __name__ == "__main__":
    auth_with_pa_valid_and_pi_token_creation("TC50171_3", "4000000000001091", "01", "2023", "001", "HKD",  "30.00", "John", "Smith", "201 S. Division St._1", "Foster City", "00000", "HK", "accept@cybs.com", "6504327113", "OiCtXA1j1AxtSNDh5lt1", False)