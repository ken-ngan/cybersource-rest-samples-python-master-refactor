...
def google_pay_auth(flag, referenceCode, googlePayBlob, totalAmount, currency, firstName, lastName, address, locality, postalCode, country, email, phoneNumber):
    ...
    print("\n----- samples/Payments/Payments/google-pay-auth.py -----")
...
if __name__ == "__main__":
    google_pay_auth(False, "test_google_pay", "RklEPUVNVi5QQVlNRU5ULkFQSQ==", "100", "HKD", "Ken", "Ngan", "27/F, Manhattan Place", "Kowloon Bay", "00000", "HK", "ken.ngan@globalpay.com", "35293565")
