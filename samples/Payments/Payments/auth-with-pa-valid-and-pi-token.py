...
def auth_with_pa_valid_and_pi_token(referenceInfoCode, paymentInstrumentId, expMonth, expYear, totalAmount, currency, firstName, lastName, address, locality, postalCode, country, email, phone, transaction_id):
    ...
    print("\n----- samples/Payments/Payments/auth-with-pi-token-and-pa-valid.py -----")
...
if __name__ == "__main__":
    auth_with_pa_valid_and_pi_token("TC50171_3", "FE39A95B0BDC3DF2E053AF598E0A0D57", "12", "2031", "102.21", "USD", "John", "Doe", "1 Market St", "san franciso", "00000", "HK", "test@cybs.com", "4158880000",  "OiCtXA1j1AxtSNDh5lt1")
