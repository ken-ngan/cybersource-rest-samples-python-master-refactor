...
def authorize_initial_recurring_payments_with_instrument_identifier(clientReferenceCode, instrumentIdentifierId, totalAmount, currency):
    clientReferenceInformationCode = clientReferenceCode
    clientReferenceInformation = Ptsv2paymentsClientReferenceInformation(
        code = clientReferenceInformationCode
    )
    
    processingInformationAuthorizationOptionsInitiatorType = "customer"
...
if __name__ == "__main__":
    authorize_initial_recurring_payments_with_instrument_identifier("TC50171_3", "FF285CF3AFFBBDC0E053A2598D0AD71E", "102.21", "HKD")
