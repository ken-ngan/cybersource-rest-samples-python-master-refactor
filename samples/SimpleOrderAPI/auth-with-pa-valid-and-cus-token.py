...
def auth_with_pa_valid_and_cus_token(referenceCode, savedToken, totalAmount, currency, firstName, lastName, address, city, postalCode, country, email, phone, transaction_id):
    ...
    # data_transaction['card_expirationMonth'] = '0'
    # data_transaction['card_expirationYear'] = '0'
    # data_transaction['card_cardType'] = cardType
    
    # data_transaction['paySubscriptionUpdateService_run'] = 'true'
    
    data_transaction['ccAuthService_run'] = 'true'
    data_transaction['ccAuthService_commerceIndicator'] = 'recurring_internet'
...
if __name__ == '__main__':
    auth_with_pa_valid_and_cus_token("BC250515D_recurring_internet", "3527DE399A58BDC9E0631E588D0A9664", "1.00", "HKD", "John", "Smith", "201 S. Division St._1", "Foster City", "00000", "HK", "accept@cybs.com", "6504327113", "OiCtXA1j1AxtSNDh5lt1")
