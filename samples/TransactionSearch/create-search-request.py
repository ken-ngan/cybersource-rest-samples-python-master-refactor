...
def create_search_request(referenceCodeNumber):
    save = False
    name = "MRN"
    timezone = "Asia/Hong_Kong"
    query = "clientReferenceInformation.code:"+referenceCodeNumber
    offset = 0
    limit = 100
...
if __name__ == "__main__":
    create_search_request("KN241212130248")
