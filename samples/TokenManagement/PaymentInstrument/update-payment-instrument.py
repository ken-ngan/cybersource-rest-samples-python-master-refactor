...
def update_payment_instrument():
    ...
    paymentInstrumentTokenId = "FE11CF4778A6B26BE053AF598E0A62EA"
    ...
    instrumentIdentifierId = "FE1152EF70CE53F9E053AF598E0AA529"
    ...
    try:
        ...
        return_data, status, body = api_instance.patch_payment_instrument(paymentInstrumentTokenId, requestObj)
