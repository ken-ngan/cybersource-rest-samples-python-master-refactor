...
def retrieve_payment_instrument(paymentInstrumentTokenId):
    profileid = "93B32398-AD51-4CC2-A682-EA3E93614EB1"

    #time.sleep(10)
    print("\n----- samples/TokenManagement/PaymentInstrument/retrieve-payment-instrument.py -----")

    try:
        config_obj = configuration.Configuration()
        client_config = config_obj.get_configuration()
        api_instance = PaymentInstrumentApi(client_config)
        return_data, status, body = api_instance.get_payment_instrument(paymentInstrumentTokenId)
...
if __name__ == "__main__":
    retrieve_payment_instrument("9503728008146655")