...
def delete_payment_instrument(paymentInstrumentTokenId):
    try:
        time.sleep(15)
        config_obj = configuration.Configuration()
        client_config = config_obj.get_configuration()
        api_instance = PaymentInstrumentApi(client_config)
        return_data, status, body = api_instance.delete_payment_instrument(paymentInstrumentTokenId)
...
if __name__ == "__main__":
    delete_payment_instrument("7375362244696564703954")
