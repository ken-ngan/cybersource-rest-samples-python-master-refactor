...
def update_customer_shipping_address():
    ...
    requestObj = PatchCustomerShippingAddressRequest(
        default = _default,
    ...
    try:
        ...
        return_data, status, body = api_instance.patch_customers_shipping_address(customerTokenId, shippingAddressTokenId, requestObj)
        ...
        print("\nException when calling CustomerShippingAddressApi->patch_customers_shipping_address: %s\n" % e)
