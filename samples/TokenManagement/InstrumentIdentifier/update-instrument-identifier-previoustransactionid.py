...
def update_instrument_identifier_previoustransactionid():
    ...
    instrumentIdentifierTokenId = "783FF33F52277CF3E05341588E0A85A3"

    processingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransactionPreviousTransactionId = "123456789012345"
    processingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransactionOriginalAuthorizedAmount = "100.00"
    processingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransaction = Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbeddedInstrumentIdentifierProcessingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransaction(
        ...
        original_authorized_amount = processingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransactionOriginalAuthorizedAmount
    )
    ...
    try:
        ...
        return_data, status, body = api_instance.patch_instrument_identifier(instrumentIdentifierTokenId, requestObj)
