...
def delete_instrument_identifier(id):
    profileid = "93B32398-AD51-4CC2-A682-EA3E93614EB1"
    

    try:
        instrumentIdentifierTokenId = id
        config_obj = configuration.Configuration()
        client_config = config_obj.get_configuration()
        api_instance = InstrumentIdentifierApi(client_config)
        return_data, status, body = api_instance.delete_instrument_identifier(instrumentIdentifierTokenId)
...
if __name__ == "__main__":
    delete_instrument_identifier("7048890000853513294")
