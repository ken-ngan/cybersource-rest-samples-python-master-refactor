...
def enroll_instrument_identifier_for_network_tokenization():
    ...
    instrumentIdentifierTokenId = "FE1152EF70CE53F9E053AF598E0AA529"
    ...
    try:
        ...
        return_data, status, body = api_instance.post_instrument_identifier_enrollment(instrumentIdentifierTokenId, requestObj)
