...
def list_payment_instruments_for_instrument_identifier():
    ...
    instrumentIdentifierTokenId = "7048890000853513294"
    ...
    try:
        ...
        return_data, status, body = api_instance.get_instrument_identifier_payment_instruments_list(instrumentIdentifierTokenId)
