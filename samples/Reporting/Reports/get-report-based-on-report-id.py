...
def get_report_based_on_report_id(reportId):
    ...
    try:
        ...
        return_data, status, body = api_instance.get_report_by_report_id(reportId)
...
if __name__ == "__main__":
    get_report_based_on_report_id("79642c43-2368-0cd5-e053-a2588e0a7b3c")
