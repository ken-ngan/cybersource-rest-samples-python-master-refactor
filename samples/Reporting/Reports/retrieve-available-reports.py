...
def retrieve_available_reports(startTime, endTime, timeQueryType, reportMimeType):
...
if __name__ == "__main__":
    retrieve_available_reports("2023-04-01T00:00:00Z", "2023-04-03T23:59:59Z", "executedTime", "text/csv")
