...
config = SourceFileLoader("module.name", config_file).load_module()

class Configuration:
    def __init__(self):        
        self.authentication_type ="http_signature"
        # self.authentication_type ="jwt"
        self.merchantid = config.MERCHANT_ID #modified
        self.alternative_merchantid = "testrest_cpctv"
        self.run_environment = config.API_ENDPOINT
        ...
        # JWT PARAMETERS
        self.key_alias = "gpproduct" #modified
        self.key_pass = "gpproduct" #modified
        self.key_file_name = "gpproduct" #modified
        ...
        # HTTP PARAMETERS
        self.merchant_keyid = config.MERCHANT_KEY_ID #modified
        self.merchant_secretkey = config.MERCHANT_SECRET_KEY #modified
